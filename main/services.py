...
def crear_inmueble(nombre:str, descripcion:str, m2_construidos:int, m2_totales:int, num_estacionamientos:int, num_habitaciones:int, num_baños:int, direccion:str, precio_mensual_arriendo:int, tipo_de_inmueble:str, comuna_cod, rut_propietario:str):
...
def crear_user(username:str, first_name:str, last_name:str, email:str, password:str, pass_confirm:str, direccion:str, rol:str='arrendatario', telefono:str=None) -> bool:
    if password != pass_confirm:
        return False
    try:
        user = User.objects.create_user(#crea los campos 
            username,
            email,
            password,
        ...
        return False
    UserProfile.objects.create(#toma user y agrega los campos faltantes
        direccion=direccion,
...
#consultar con sql haciendo join
